...
function(array){
var copy =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/array.length, 0);
...
var common =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0);
...
c$.copyArray = Clazz.defineMethod(c$, "copyArray", 
function(array){
var copy =  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.QualifiedName*/array.length, 0);
System.arraycopy(array, 0, copy, 0, array.length);
return copy;
}, "~A");
c$.createArray = Clazz.defineMethod(c$, "createArray", 
function(size){
return  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/size, 0);
}, "~N");
...
function(size){
return  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.SimpleName*/size, 0);
}, "~N");
c$.createLArray = Clazz.defineMethod(c$, "createLArray", 
function(size){
return  Clazz.newLongArray (/*org.eclipse.jdt.core.dom.SimpleName*/size, 0);
}, "~N");
...
return  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/size1, /*org.eclipse.jdt.core.dom.SimpleName*/size2, 0);
}, "~N,~N");
