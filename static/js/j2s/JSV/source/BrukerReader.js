...
var data1r =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0);
var data1i =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0);
var data2rr =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0);
var root = null;
var title = null;
...
var data1i = (this.allowPhasing ? this.getFileContentsAsBytes( new java.io.File(procs.getParent(), "1i")) :  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0));
...
var ad =  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.SimpleName*/len, 0);
var d = 0;
...
function(file){
if (!file.exists()) return  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0);
var len = file.length();
...
return  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0);
