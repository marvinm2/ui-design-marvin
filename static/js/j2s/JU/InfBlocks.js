...
this.bb =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
this.tb =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
this.bl =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
this.bd =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
this.tli =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
this.tdi =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
...
this.hufts =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.InfixExpression*/4320, 0);
this.window =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.SimpleName*/w, 0);
this.end = w;
...
this.blens =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/t, 0);
} else {
for (var i = 0; i < t; i++) {
this.blens[i] = 0;
}
