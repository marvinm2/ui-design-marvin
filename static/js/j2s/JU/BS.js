...
function(nbits){
this.words =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.InfixExpression*/JU.BS.wordIndex(nbits - 1) + 1, 0);
}, "~N");
...
c$.emptyBitmap =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0);
});
