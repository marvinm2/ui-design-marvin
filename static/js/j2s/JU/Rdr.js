...
{
is.resetStream();
}var abMagic =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/4, 0);
abMagic[3] = 1;
try {
is.mark(5);
} catch (e) {
...
function(is, n){
var abMagic = (n > 264 ?  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0) : JU.Rdr.b264 == null ? (JU.Rdr.b264 =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/265, 0)) : JU.Rdr.b264);
{
is.resetStream();
}try {
abMagic[264] = -1;
...
function(bis, out){
var buf =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1024, 0);
var bytes = (out == null ?  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/4096, 0) : null);
var len = 0;
var totalLen = 0;
...
var buf =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.SimpleName*/buflen, 0);
var bytes =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.ConditionalExpression*/n < 0 ? 4096 : n, 0);
var len = 0;
var totalLen = 0;
if (n < 0) n = 2147483647;
...
buf =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.SimpleName*/totalLen, 0);
...
var data =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0);
bis.mark(75);
try {
var pt_count =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/2, 0);
