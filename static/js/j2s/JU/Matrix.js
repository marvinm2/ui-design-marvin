...
function(a, m, n){
this.a = (a == null ?  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.SimpleName*/m, /*org.eclipse.jdt.core.dom.SimpleName*/n, 0) : a);
this.m = m;
this.n = n;
}, "~A,~N,~N");
...
function(){
var x =  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.m, /*org.eclipse.jdt.core.dom.SimpleName*/this.n, 0);
...
this.piv =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/m, 0);
for (var i = m; --i >= 0; ) this.piv[i] = i;

this.pivsign = 1;
var LUrowi;
var LUcolj =  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.SimpleName*/m, 0);
for (var j = 0; j < n; j++) {
