...
this.t8 =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/8, 0);
});
...
function(n){
var b =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
...
function(nChar){
var temp =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.SimpleName*/nChar, 0);
...
this.readByteArray( Clazz.newByteArray (/*org.eclipse.jdt.core.dom.CastExpression*/offset, 0), 0, offset);
}this.nBytes += offset;
} catch (e) {
if (Clazz.exceptionOf(e,"java.io.IOException")){
