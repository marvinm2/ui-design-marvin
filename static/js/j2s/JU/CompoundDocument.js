...
var nSID = 0;
var thisSID;
this.SAT =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.InfixExpression*/this.header.nSATsectors * this.nIntPerSector + 109, 0);
try {
for (var i = 0; i < 109; i++) {
...
var MSAT =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.nIntPerSector, 0);
...
this.SSAT =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/nMax, 0);
try {
...
var data =  new JU.SB();
var byteBuf =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.sectorSize, 0);
...
var ptShort = 0;
var byteBuf =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.shortSectorSize, 0);
var gzipData =  new JU.ZipData(nBytes);
try {
