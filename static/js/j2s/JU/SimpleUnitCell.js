...
var scaleMatrix =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/16, 0);
for (var i = 0; i < 16; i++) {
var f;
switch (i % 4) {
case 0:
...
var p =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/27, 0);
var n = params.length;
...
if (abcabg != null) {
if (params == null) params =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/6, 0);
...
if (haveDigit && !haveDecimal) parts[i] += ".";
}
s = JU.PT.join(parts, '/', 0);
