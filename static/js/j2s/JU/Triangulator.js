...
var t1 =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/4, 0);
...
var insideMask = 0;
var values =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/8, 0);
for (var i = 0; i < 8; i++) {
...
v.addLast(pts);
var list =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/12, 0);
var ptList = 0;
for (var i = 0; i < triangles.length; i++) {
var pt = triangles[i];
if (bsPoints.get(pt)) {
