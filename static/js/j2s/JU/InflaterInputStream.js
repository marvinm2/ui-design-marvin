...
this.byte1 =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
this.b =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/512, 0);
});
Clazz.makeConstructor(c$, 
function($in, inflater, size, close_in){
Clazz.superConstructor(this, JU.InflaterInputStream, [$in]);
this.inflater = inflater;
this.buf =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.SimpleName*/size, 0);
...
var tmp =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.inflater.avail_in, 0);
...
return;
}var b1 =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
do {
