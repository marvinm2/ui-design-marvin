...
function(str){
return JU.PT.parseFloatArrayNext(str,  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0), null, null, null);
}, "~S");
...
if (f == null) f =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/tokens.length, 0);
n = JU.PT.parseFloatArrayInfested(tokens, f);
}if (f == null) return  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0);
...
var next =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
next[0] = ich;
...
var x =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/len, 0);
var m = info;
sb.appendC('[');
for (var i = 0; i < len; i++) {
if (i > 0) sb.appendC(',');
