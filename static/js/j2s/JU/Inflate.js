...
this.crcbuf =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/4, 0);
});
...
if (this.gheader != null) {
this.gheader.extra =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.InfixExpression*/(this.need) & 0xffff, 0);
}if ((this.flags & 0x0200) != 0) {
this.checksum(2, this.need);
