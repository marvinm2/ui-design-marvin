...
tmp =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.QualifiedName*/gheader.extra.length, 0);
System.arraycopy(gheader.extra, 0, tmp, 0, tmp.length);
gheader.extra = tmp;
}if (gheader.name != null) {
tmp =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.QualifiedName*/gheader.name.length, 0);
System.arraycopy(gheader.name, 0, tmp, 0, tmp.length);
gheader.name = tmp;
}if (gheader.comment != null) {
tmp =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.QualifiedName*/gheader.comment.length, 0);
