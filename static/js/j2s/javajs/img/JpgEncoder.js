...
var yblockoffset;
var inputArray;
var dctArray1 =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/8, /*org.eclipse.jdt.core.dom.NumberLiteral*/8, 0);
var dctArray2 =  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/8, /*org.eclipse.jdt.core.dom.NumberLiteral*/8, 0);
var dctArray3 =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.InfixExpression*/64, 0);
var lastDCvalue =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/jpegObj.numberOfComponents, 0);
var minBlockWidth;
var minBlockHeight;
...
var dqt =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/134, 0);
dqt[0] = 0xFF;
dqt[1] = 0xDB;
dqt[2] = 0;
dqt[3] = 132;
...
this.writeArray(dqt);
var sof =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/19, 0);
sof[0] = 0xFF;
sof[1] = 0xC0;
sof[2] = 0;
sof[3] = 17;
...
var sos =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/14, 0);
sos[0] = 0xFF;
sos[1] = 0xDA;
sos[2] = 0;
sos[3] = 12;
...
function(length, id){
length += 2;
var com =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/4, 0);
com[0] = 0xFF;
com[1] = id;
com[2] = ((length >> 8) & 0xFF);
com[3] = (length & 0xFF);
...
dht =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.InfixExpression*/21 + bytes, 0);
dht[0] = 0xFF;
dht[1] = 0xC4;
var index = 4;
...
this.quantum_luminance =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/64, 0);
this.DivisorsLuminance =  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.SimpleName*/64, 0);
this.quantum_chrominance =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/64, 0);
this.DivisorsChrominance =  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.SimpleName*/64, 0);
});
Clazz.makeConstructor(c$, 
function(quality){
...
function(input){
var output =  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.SimpleName*/8, /*org.eclipse.jdt.core.dom.SimpleName*/8, 0);
var tmp0;
var tmp1;
var tmp2;
var tmp3;
...
var outputData =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/64, 0);
...
function(){
this.dc_matrix0 =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/12, /*org.eclipse.jdt.core.dom.NumberLiteral*/2, 0);
this.dc_matrix1 =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/12, /*org.eclipse.jdt.core.dom.NumberLiteral*/2, 0);
this.ac_matrix0 =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/255, /*org.eclipse.jdt.core.dom.NumberLiteral*/2, 0);
this.ac_matrix1 =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/255, /*org.eclipse.jdt.core.dom.NumberLiteral*/2, 0);
...
var si;
var code;
var huffsize =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/257, 0);
var huffcode =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/257, 0);
p = 0;
for (l = 1; l <= 16; l++) {
...
this.compWidth =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.numberOfComponents, 0);
this.compHeight =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.numberOfComponents, 0);
this.blockWidth =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.numberOfComponents, 0);
this.blockHeight =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.numberOfComponents, 0);
});
...
var Y =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.ArrayAccess*/this.compHeight[0], /*org.eclipse.jdt.core.dom.ArrayAccess*/this.compWidth[0], 0);
var Cr1 =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.ArrayAccess*/this.compHeight[0], /*org.eclipse.jdt.core.dom.ArrayAccess*/this.compWidth[0], 0);
var Cb1 =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.ArrayAccess*/this.compHeight[0], /*org.eclipse.jdt.core.dom.ArrayAccess*/this.compWidth[0], 0);
