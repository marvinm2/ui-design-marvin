...
var f = (oldData == null || createNew ?  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/actualAtomCount, 0) : JU.AU.ensureLengthA(oldValue, actualAtomCount));
...
if (n == bs.cardinality()) {
for (var i = bs.nextSetBit(0), pt = 0; i >= 0; i = bs.nextSetBit(i + 1), pt++) this.fillSparseArray(ffData[pt], bs, ff[i] =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/actualAtomCount, 0));
...
var fValues =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/nValues, 0);
...
var fnew =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/bsSelected.cardinality(), 0);
