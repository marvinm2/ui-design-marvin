...
if (bsAtoms == null) bsAtoms = this.bsA();
var nTotal =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
...
function(eval, point1, point2, degreesPerSecond, endDegrees, isSpin, bsSelected, translation, finalPoints, dihedralList, m4, useModelKit, centerAndPoints){
if (eval == null) eval = this.eval;
if (this.headless) {
if (isSpin && endDegrees == 3.4028235E38) return false;
isSpin = false;
}var isOK = this.tm.rotateAboutPointsInternal(eval, point1, point2, degreesPerSecond, endDegrees, false, isSpin, bsSelected, false, translation, finalPoints, dihedralList, m4, useModelKit, centerAndPoints);
if (isOK) this.setSync();
return isOK;
}, "J.api.JmolScriptEvaluator,JU.P3,JU.P3,~N,~N,~B,JU.BS,JU.V3,JU.Lst,~A,JU.M4,~B,~A");
...
return;
}this.tm.rotateAboutPointsInternal(null, pt1, pt2, this.g.pickingSpinRate, 3.4028235E38, isClockwise, true, null, false, null, null, null, null, false, null);
}, "JU.T3,JU.T3,~B");
...
case 3:
case 4:
var lengths =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/nb, 0);
var points =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/nb, 0);
var ni = 0;
...
data = "";
}fdata =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/nX, /*org.eclipse.jdt.core.dom.SimpleName*/nY, 0);
var f =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.InfixExpression*/nX * nY, 0);
...
data = "";
}xyzdata =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/nX, /*org.eclipse.jdt.core.dom.SimpleName*/nY, /*org.eclipse.jdt.core.dom.SimpleName*/nZ, 0);
var f =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.InfixExpression*/nX * nY * nZ, 0);
JU.Parser.parseStringInfestedFloatArray(data, null, f);
...
function(mode){
this.userVdwMars =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/JU.Elements.elementNumberMax, 0);
this.userVdws =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/JU.Elements.elementNumberMax, 0);
...
;//5.0.1-v4 Sat Dec 21 16:19:09 CST 2024
