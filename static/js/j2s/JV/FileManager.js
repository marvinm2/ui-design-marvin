...
if (errMsg[0] != null) {
if (asBytes) return  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0);
...
try {
is.mark(300);
var buf =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/300, 0);
is.read(buf, 0, 300);
is.reset();
if ((buf[0] & 0xFF) == 0x83) {
