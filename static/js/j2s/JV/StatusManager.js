...
return (this.jsl == null ?  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/Math.abs(nX), /*org.eclipse.jdt.core.dom.MethodInvocation*/Math.abs(nY), 0) : this.jsl.functionXY(functionName, nX, nY));
}, "~S,~N,~N");
Clazz.defineMethod(c$, "functionXYZ", 
function(functionName, nX, nY, nZ){
return (this.jsl == null ?  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/Math.abs(nX), /*org.eclipse.jdt.core.dom.MethodInvocation*/Math.abs(nY), /*org.eclipse.jdt.core.dom.MethodInvocation*/Math.abs(nY), 0) : this.jsl.functionXYZ(functionName, nX, nY, nZ));
}, "~S,~N,~N,~N");
