...
function(pt){
this.rd();
var data =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/this.asc.getLastAtomSetAtomCount(), 0);
...
tokens = gdata.get(i);
this.gaussians[i] =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/tokens.length, 0);
...
var temp = null;
var atomIndices =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/ac, 0);
...
var data =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, /*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
var k0 = 0;
while (true) {
this.rd();
for (var i = k0; i < n; i++) {
