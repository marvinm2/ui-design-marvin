...
function(f0, i, n){
var f =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
...
case 73:
case 82:
o = this.fillFloatArray(null, 0,  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/this.parseIntStr(v), 0));
this.line = null;
break;
default:
v = this.rd().trim();
...
var g = this.gaussians[this.gaussianCount] =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
...
var coefs =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/nCoef, 0);
