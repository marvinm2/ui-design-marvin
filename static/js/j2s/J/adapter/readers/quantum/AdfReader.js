...
sd.basisFunctions =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/tokens.length, 0);
...
var atomList =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/nAtoms, 0);
...
sd.coefs =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/sd.nSFO, /*org.eclipse.jdt.core.dom.SimpleName*/nBF, 0);
while (n < sd.nBF) {
this.rd();
...
var charges =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
for (var i = 0; i < n; i++) {
this.rd();
var tokens = this.getTokens();
