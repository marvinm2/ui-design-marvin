...
for (var i = 0; i < this.gaussianCount; i++) this.gaussians[i] =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/6, 0);
...
var f =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/tokens.length, 0);
...
var temp = this.fillFloatArray(this.line, 0,  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.gaussianCount, 0));
...
next =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
...
var coefs =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/nAOs, 0);
if (isAO) {
coefs[i % nAOs] = 1;
...
var occupancies =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/nAOs, 0);
...
var coefs =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.nAOs, 0);
if (isAO) {
...
function(pt){
var occupancies =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.nNOs, 0);
