...
this.atomicNumbers =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.ac, 0);
...
this.nCoefficients = 0;
this.getSlaters();
var values =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
...
list =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.nCoefficients, /*org.eclipse.jdt.core.dom.SimpleName*/this.nCoefficients, 0);
...
this.orbitalData.addLast(data =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.nCoefficients, 0));
...
for (var iMo = 0; iMo < this.nCoefficients; iMo++) this.fillFloatArray(null, 15, this.invMatrix[iMo] =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.InfixExpression*/iMo + 1, 0));
...
}var list2 =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.nOrbitals, /*org.eclipse.jdt.core.dom.SimpleName*/this.nCoefficients, 0);
...
var values =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/2, 0);
