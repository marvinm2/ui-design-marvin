...
var matrix =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/nAtoms, /*org.eclipse.jdt.core.dom.SimpleName*/nAtoms, 0);
...
var raw =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/tokens.length, 0);
var n = JU.PT.parseFloatArrayInfested(tokens, raw);
var table =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/nAtoms, /*org.eclipse.jdt.core.dom.SimpleName*/nAtoms, 0);
var atom1 = -1;
var atom2 = 0;
var atom0 = 0;
for (var i = 0; i < n; i++) {
...
raw =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/tokens.length, 0);
...
matrix =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/nAtoms, /*org.eclipse.jdt.core.dom.SimpleName*/nAtoms, 0);
htData.put("matrix", matrix);
...
if (needLP) {
structureMap.put("lplv", lplv =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/atomCount, 0));
structureMap.put("bondCounts", bondCounts =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/atomCount, 0));
}if (needLP) {
if (lonePairs != null) {
