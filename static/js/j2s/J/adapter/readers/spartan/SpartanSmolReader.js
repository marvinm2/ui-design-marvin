...
var bytes =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.QualifiedName*/tokens.length, 0);
for (var i = 0; i < tokens.length; i++) bytes[i] = JU.PT.parseIntRadix(tokens[i], 16);

mat =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/16, 0);
