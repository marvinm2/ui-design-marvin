...
var typeArray =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.gaussianCount, 0);
...
var data =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.InfixExpression*/nData + 1, 0);
data[0] = alpha;
switch (typeArray[i]) {
case 0:
...
var energies =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.moCount, 0);
var coefficients =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.moCount, /*org.eclipse.jdt.core.dom.SimpleName*/this.coefCount, 0);
...
var iatom = ac;
var nValues = 3;
var atomInfo =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
