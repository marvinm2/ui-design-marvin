...
function(){
this.stickBallRatio = this.floatSetting(277);
this.stickBalls = this.floatSetting(276);
this.stickRadius = this.floatSetting(21);
this.valence = this.floatSetting(64);
...
var pymolView =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/21, 0);
...
if (labelPos == null) labelPos =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/7, 0);
labelPos[0] = 1;
if (isPlacement) {
labelPos[4] = offset.x;
labelPos[5] = offset.y;
...
offset = (J.adapter.readers.pymol.PyMOLReader.floatsAt(J.adapter.readers.pymol.PyMOLReader.listAt(offsets, index), 0,  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/7, 0), 7));
if (offset == null) offset = this.setLabelPosition(this.labelPosition,  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/7, 0), false);
...
var fontSize = this.floatSetting(453);
var text = this.newTextLabel(strFormat, offset, clabel, Clazz.floatToInt(this.floatSetting(328)), fontSize);
...
var colixes = (setColor == 0 ? null :  Clazz.newShortArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0));
var atrans = (setTrans == 0 ? null :  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0));
var sizes =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
