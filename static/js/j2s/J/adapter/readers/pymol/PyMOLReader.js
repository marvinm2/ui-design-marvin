...
this.aTemp =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/16, 0);
...
var bytes =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.InfixExpression*/bytes0.length - nExcluded, 0);
...
this.jmolToUniqueID =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/nAtomsJmol, 0);
for (var j = 0; j < this.stateCount; j++) {
...
System.out.println("PyMOL global setting " + setting);
}}
return settings;
}, "JU.Lst");
...
n++;
if (type != 64) System.out.println("UniqueSetting " + id + " " + setting);
...
this.frames =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/list.size(), 0);
...
var bsReps = J.adapter.readers.pymol.PyMOLReader.getBsReps(setting, 3);
...
idxArray =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/nAtoms, 0);
coordsArray =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.InfixExpression*/nAtoms * 3, 0);
this.fillFloatArrayFromBytes(state.get(2), coordsArray);
this.fillIntArrayFromBytes(state.get(3), idxArray);
var b = state.get(8);
if (b != null) {
labelArray =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.InfixExpression*/nAtoms * 7, 0);
...
this.atomMap =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/nAtoms, 0);
...
var index =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
var imax = 0;
for (var i = 0; i < n; i++) {
pt += 4;
...
order |= (order == 1 || asSingle && !isSpecial ? 65536 : 98304);
...
anisou =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/8, 0);
...
bsReps = J.adapter.readers.pymol.PyMOLReader.getBsReps(a, 20);
...
uniqueID = (a.size() > 40 && J.adapter.readers.pymol.PyMOLReader.intAt(a, 40) == 1 ? J.adapter.readers.pymol.PyMOLReader.intAt(a, 32) : 0);
if (a.size() > 46) anisou = J.adapter.readers.pymol.PyMOLReader.floatsAt(a, 41,  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/8, 0), 6);
}if (uniqueID == 0) {
uniqueID = -1;
if (uniqueIds != null) {
var id = uniqueIds.get(idx);
if (id != null) {
uniqueID = id.intValue();
}}}if (this.forceValence || this.pymolScene.getUniqueFloatDef(uniqueID, 64, this.pymolScene.valence) == 1) {
...
if (this.pymolScene.getUniqueFloatDef(uniqueID, 64, this.pymolScene.valence) == 1) {
this.bsValence.set(apt);
...
var labelPos =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/7, 0);
if (labelArray != null) {
...
this.jmolToUniqueID[this.$ac] = uniqueID;
...
var a1 = this.atomMap[bond.atomIndex1];
var a2 = this.atomMap[bond.atomIndex2];
if (a1 < 0 || a2 < 0) continue;
bond.atomIndex1 = a1;
bond.atomIndex2 = a2;
this.checkStickBall(a1);
this.checkStickBall(a2);
this.pymolScene.setUniqueBond(this.bondCount++, bond.uniqueID);
this.asc.addBond(bond);
}
}, "JU.Lst");
Clazz.defineMethod(c$, "checkStickBall", 
function(iatom){
var id = this.jmolToUniqueID[iatom];
var radius = (this.pymolScene.getUniqueFloatDef(id, 276, this.pymolScene.stickBalls));
if (radius == 1) {
radius = this.pymolScene.getUniqueFloatDef(id, 21, this.pymolScene.stickRadius) * this.pymolScene.getUniqueFloatDef(id, 277, this.pymolScene.stickBallRatio);
} else {
radius = 0;
}this.pymolScene.addSpacefill(iatom, radius, false);
}, "~N");
...
function(){
var cartoonTypes =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.$ac, 0);
var uniqueIDs =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.$ac, 0);
var sequenceNumbers =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.$ac, 0);
var newChain =  Clazz.newBooleanArray(this.$ac, false);
var radii =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.$ac, 0);
