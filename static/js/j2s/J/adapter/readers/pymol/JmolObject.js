...
var c =  Clazz.newShortArray (/*org.eclipse.jdt.core.dom.InfixExpression*/colixes.length + atomOffset, 0);
...
function(){
return "[JmolObject " + this.id + " " + (this.bsAtoms == null ? "" : this.bsAtoms.cardinality() + " atoms") + "]";
});
});
