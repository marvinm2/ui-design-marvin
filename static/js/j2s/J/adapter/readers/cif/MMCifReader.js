...
var m =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/16, 0);
m[15] = 1;
while (this.cifParser.getData()) {
var count = 0;
var id = null;
...
var m4 =  new JU.M4();
if (count != 12) {
this.symmetry.getMatrixFromString(xyz, m);
...
this.chainAtomCounts.put(assemblyId,  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0));
...
this.chainAtomCounts.put(strChain, this.chainAtomCount =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0));
