...
var a =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
try {
switch (byteLen) {
case 4:
...
if (b == null) return null;
var n = Clazz.doubleToInt(b.length / byteLen);
var ret =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.ConditionalExpression*/rowCount == 0 ? n : rowCount, 0);
...
if (b == null) return null;
var ret =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/srcSize, 0);
var a = (run == null ? ret : run);
var max;
switch (byteLen) {
case 1:
...
function(n){
if (J.adapter.readers.cif.BCIFDecoder.temp == null || J.adapter.readers.cif.BCIFDecoder.temp.length < n) J.adapter.readers.cif.BCIFDecoder.temp =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/Math.max(n, 1000), 0);
