...
return;
}this.htModulation.put("X_" + this.atModel,  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0));
...
var p =  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.QualifiedName*/params.length, 0);
...
this.qlist100 =  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.modDim, 0);
this.qlist100[0] = 1;
...
if (ifn != 0) {
p =  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.modDim, 0);
p[i] = ifn;
return p;
}}
var p3 = this.toP3(p);
...
a.anisoBorU =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/8, 0);
