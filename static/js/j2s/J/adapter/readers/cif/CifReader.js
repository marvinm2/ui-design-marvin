...
this.col2key =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/100, 0);
this.key2col =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/100, 0);
});
...
if (ret && isHKL) System.err.println("CIFReader reading _shelx_hkl_file; use FILTER 'StopOnShelxHKL' to stop when this is found");
return ret;
}, "~S");
...
var f =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.InfixExpression*/this.modDim + 4, 0);
...
if (this.isMolecular) {
this.atomRadius =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.ac, 0);
for (var i = this.firstAtom; i < this.ac; i++) {
