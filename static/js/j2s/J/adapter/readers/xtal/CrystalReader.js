...
this.f14 =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/14, 0);
this.f16 =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/16, 0);
});
...
var ev =  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, /*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
...
function(){
this.primitiveToCrystal = JU.M3.newA9(this.fillFloatArray(null, 0,  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/9, 0)));
});
...
offset = 4;
if (i == 0) irreducible =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.ac, 0);
...
var charges =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/tokens.length, 0);
...
this.atomFrag =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/numAtomsFrag, 0);
var Sfrag = "";
...
var frequencies =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/tokens.length, 0);
...
this.processCoordLines();
var f =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.ac, 0);
