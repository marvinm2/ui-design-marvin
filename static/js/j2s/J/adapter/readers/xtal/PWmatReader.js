...
function(){
var unitCellData =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
...
var cx =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.nAtoms, 0);
var cy =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.nAtoms, 0);
var cz =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.nAtoms, 0);
...
name = "pwm_" + name;
if (values == null) {
values =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.nAtoms, 0);
} else {
this.getLine();
}var n = 0;
for (var i = 0; ; ) {
...
var valuesX =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.nAtoms, 0);
var valuesY =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.nAtoms, 0);
var valuesZ =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.nAtoms, 0);
var n = 0;
for (var i = 0; ; ) {
var tokens = this.getTokens();
...
var map = (n == this.nAtoms ? null :  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.nAtoms, 0));
if (map != null) {
...
var af = e.getValue();
var af2 =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
...
this.setProperties("pwm_magnetic",  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.asc.ac, 0), this.nAtoms);
}});
});
