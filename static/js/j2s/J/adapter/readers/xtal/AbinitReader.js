...
function(){
this.fillFloatArray(this.line.substring(12), 0, this.typeArray =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.nAtom, 0));
});
Clazz.defineMethod(c$, "readAtomSpecies", 
function(){
this.znucl =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.nType, 0);
...
function(){
var f = 0;
this.cellLattice =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/9, 0);
for (var i = 0; i < 9; i++) {
if (i % 3 == 0) {
...
if (this.znucl == null) this.fillFloatArray(this.line.substring(12), 0, this.znucl =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.nType, 0));
var atoms = this.asc.atoms;
