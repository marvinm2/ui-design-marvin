...
return;
}var lv =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
for (var i = 0; i < 3; i++) {
lv[0] = this.abc[i].x;
lv[1] = this.abc[i].y;
lv[2] = this.abc[i].z;
...
function(s){
var f = JU.SimpleUnitCell.parseCalc(this.vwr, J.adapter.readers.xtal.CastepReader.functions, s);
if (Float.isNaN(f)) {
...
this.rd();
var atoms = this.asc.atoms;
var spins = (haveSpin ?  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/atoms.length, 0) : null);
