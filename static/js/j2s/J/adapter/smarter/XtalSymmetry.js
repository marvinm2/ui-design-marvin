...
var lc = (this.latticeCells != null && this.latticeCells[0] != 0 ?  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0) : null);
...
var atomMap = (addBonds ?  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.asc.ac, 0) : null);
...
}var atomMap = (this.bondCount0 > this.asc.bondIndex0 && this.applySymmetryToBonds ?  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0) : null);
var unitCells =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/nCells, 0);
...
var f = val;
var fnew =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.InfixExpression*/f.length * nTimes, 0);
...
this.unitCellParams =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/info.length, 0);
...
var parts =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/this.asc.getAtomSetAtomCount(iset), 0);
