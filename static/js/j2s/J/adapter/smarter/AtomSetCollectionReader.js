...
this.next =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
...
function(){
this.latticeCells =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/4, 0);
this.doApplySymmetry = false;
...
if (!this.doApplySymmetry) this.latticeCells =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
});
...
this.unitCellParams =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/27, 0);
...
if (this.ucItems == null) this.ucItems =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/6, 0);
this.ucItems[i] = x;
return;
...
function(tokens, pt){
var a =  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, /*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
...
function(s, f, n){
if (f == null) f =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
...
var f =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
for (var i = 0; i < 3; i++) {
