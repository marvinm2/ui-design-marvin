...
this.shadeIndexes =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.SimpleName*/JU.GData.normixCount, 0);
this.shadeIndexes2Sided =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.SimpleName*/JU.GData.normixCount, 0);
});
...
if (this.anaglyphChannelBytes == null || this.anaglyphChannelBytes.length != this.anaglyphLength) this.anaglyphChannelBytes =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.anaglyphLength, 0);
