...
this.dataAdderOK =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/20, 0);
});
...
this.coeffs =  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.FieldAccess*/this.dfCoefMaps[this.dfCoefMaps.length - 1].length, 0);
...
this.voxelDataTemp = (isSquaredLinear ?  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.nX, /*org.eclipse.jdt.core.dom.SimpleName*/this.nY, /*org.eclipse.jdt.core.dom.SimpleName*/this.nZ, 0) : this.voxelData);
...
this.CX =  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.FieldAccess*/this.nX, 0);
this.CY =  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.FieldAccess*/this.nY, 0);
this.CZ =  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.FieldAccess*/this.nZ, 0);
this.DXY =  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.FieldAccess*/this.nX, 0);
this.DXZ =  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.FieldAccess*/this.nX, 0);
this.DYZ =  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.FieldAccess*/this.nY, 0);
this.EX =  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.FieldAccess*/this.nX, 0);
this.EY =  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.FieldAccess*/this.nY, 0);
this.EZ =  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.FieldAccess*/this.nZ, 0);
}, "~N,~N,~N,~A");
