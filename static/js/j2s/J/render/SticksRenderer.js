...
this.bond = bonds[i];
if (this.bond != null) this.renderBond();
}
} else {
for (var i = this.ms.bondCount; --i >= 0; ) {
this.bond = bonds[i];
if (this.bond != null && (this.bond.shapeVisibilityFlags & this.myVisibilityFlag) != 0 && this.renderBond()) {
...
this.multipleBondSpacing = (isPymol ? 0.26 : this.vwr.getFloat(570425370));
