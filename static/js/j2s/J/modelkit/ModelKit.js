...
this.screenXY =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/2, 0);
...
this.vwr.rotateAboutPointsInternal(null, atomFix, atomMove, 0, degrees, false, bs, null, null, null, null, true, null);
}, "~N,~N,~N,~N,~B");
...
var sites =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/maxSite, 0);
var p1 =  new JU.P3();
...
this.mk.vwr.shm.setShapeProperties(22, [ Clazz.newArray(-1, ["init", "elementKey"]),  Clazz.newArray(-1, ["thisID", key + "d_" + label]),  Clazz.newArray(-1, ["diameter", Double.$valueOf(2)]),  Clazz.newArray(-1, ["modelIndex", Integer.$valueOf(this.modelIndex)]),  Clazz.newArray(-1, ["points", Integer.$valueOf(0)]),  Clazz.newArray(-1, ["coord", JU.P3.new3(x, y, -3.4028235E38)]),  Clazz.newArray(-1, ["set", null]),  Clazz.newArray(-1, ["color", Integer.$valueOf(color)]),  Clazz.newArray(-1, ["thisID", null])]);
...
this.colors =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/120, /*org.eclipse.jdt.core.dom.NumberLiteral*/10, 0);
this.isotopeCounts =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/120, 0);
});
Clazz.makeConstructor(c$, 
function(mk, modelIndex){
...
if (!label.equals(label.toLowerCase())) label = "~_" + label;
var color = a[i].atomPropertyInt(1765808134);
...
;//5.0.1-v4 Thu Dec 19 18:33:39 CST 2024
