...
function(){
if (this.vcs == null) {
this.vcs =  Clazz.newShortArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.vc, 0);
...
}this.jvxlData.contourColixes =  Clazz.newShortArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
this.jvxlData.contourValues =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
for (var i = 0; i < n; i++) {
...
this.pcs =  Clazz.newShortArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.pc, 0);
this.colorsExplicit = false;
for (var i = 0; i < this.pc; i++) {
var p = this.pis[i];
if (p == null) continue;
...
this.jvxlData.vertexColors =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.vc, 0);
...
this.contourColixes =  Clazz.newShortArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.contourValues.length, 0);
...
if (this.pis == null) this.pis =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, /*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0);
if (m != null && m.pis == null) m.pis =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, /*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0);
...
var v =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
