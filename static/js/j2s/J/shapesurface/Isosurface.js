...
atomMap =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/bs.length(), 0);
...
this.sg.params.probeValues =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.sg.params.probes.length, 0);
}return;
...
this.setProperty("property",  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.ms.ac, 0), null);
if (colix != 0) {
...
return;
case 2:
if (mesh.vcs == null || mesh.vc > mesh.vcs.length) mesh.vcs =  Clazz.newShortArray (/*org.eclipse.jdt.core.dom.QualifiedName*/mesh.vc, 0);
