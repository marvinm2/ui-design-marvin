...
if (this.mads == null && i0 >= 0) this.mads =  Clazz.newShortArray (/*org.eclipse.jdt.core.dom.SimpleName*/ac, 0);
...
if (this.mads == null && i0 >= 0) this.mads =  Clazz.newShortArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.ms.ac, 0);
