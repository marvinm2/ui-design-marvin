...
this.coefs =  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/10, 0);
this.factoredLengths =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
...
if (this.coords == null || this.coords.length != this.dotCount * 3) this.coords =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.InfixExpression*/this.dotCount * 3, 0);
}});
...
c$.cossin =  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/36, 0);
{
