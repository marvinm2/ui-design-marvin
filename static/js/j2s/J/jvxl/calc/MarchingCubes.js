...
this.vertexValues =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/8, 0);
this.voxelVertexVectors =  new Array(8);
this.edgeVectors =  new Array(12);
{
for (var i = 12; --i >= 0; ) this.edgeVectors[i] =  new JU.V3();

}this.edgePointIndexes =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/12, 0);
this.bsValues =  new JU.BS();
this.pt0 =  new JU.P3();
this.pointA =  new JU.P3();
this.fReturn =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
this.linearOffsets =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/8, 0);
});
...
this.isoPointIndexPlanes =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/2, /*org.eclipse.jdt.core.dom.SimpleName*/this.yzCount, /*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
this.yzPlanes = (this.mode == 3 ?  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/2, /*org.eclipse.jdt.core.dom.SimpleName*/this.yzCount, 0) : null);
