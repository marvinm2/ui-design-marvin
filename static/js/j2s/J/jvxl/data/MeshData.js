...
return;
}this.vertexSets =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.vc, 0);
...
var v =  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
var vAB =  new JU.V3();
var vAC =  new JU.V3();
var vTemp =  new JU.V3();
for (var i = m.pc; --i >= 0; ) {
...
var v1 =  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/thisSet.cardinality(), 0);
