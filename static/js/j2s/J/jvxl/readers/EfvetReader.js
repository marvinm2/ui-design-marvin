...
this.vertexMap =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.InfixExpression*/this.nVertices + 1, 0);
this.jvxlData.vertexColors = null;
if (this.params.fileIndex == 0) {
this.jvxlData.vertexColors =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.nVertices, 0);
this.jvxlData.nVertexColors = 0;
}var values =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.ConditionalExpression*/this.jvxlData.vertexColors == null ? 3 : 9, 0);
