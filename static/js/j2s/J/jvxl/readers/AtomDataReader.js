...
if (getRadii) this.atomRadius =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
this.atomXyzTruncated =  new Array(n);
if (this.params.theProperty != null) this.atomProp =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
this.atomNo =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
this.atomIndex =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
this.myIndex =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.ac, 0);
for (var i = 0; i < nH; i++) {
...
this.maxRS = 0;
this.rs =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.myAtomCount, 0);
this.rs2 =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.myAtomCount, 0);
