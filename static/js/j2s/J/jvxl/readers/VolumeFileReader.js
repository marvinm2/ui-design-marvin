...
if (downsampling) {
this.downsampleRemainders =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
...
for (var y = 0; y < this.nPointsY; ++y) {
var strip =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.nPointsZ, 0);
plane[y] = strip;
for (var z = 0; z < this.nPointsZ; ++z) {
...
this.iPlaneNCI = 1;
this.qpc.setPlanes(this.yzPlanesRaw =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/4, /*org.eclipse.jdt.core.dom.SimpleName*/this.yzCount, 0));
