...
var crs2abc =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
...
this.values = this.readCifFloats("_volume_data_3d_values",  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.InfixExpression*/this.na * this.nb * this.nc, 0));
