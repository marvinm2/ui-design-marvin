...
function(){
this.volumeData.setVoxelDataAsArray(this.voxelData =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.nPointsX, /*org.eclipse.jdt.core.dom.SimpleName*/this.nPointsY, /*org.eclipse.jdt.core.dom.SimpleName*/this.nPointsZ, 0));
});
...
if (colixes == null || colixes.length < vertexCount) this.meshData.vcs = colixes =  Clazz.newShortArray (/*org.eclipse.jdt.core.dom.SimpleName*/vertexCount, 0);
if (vertexValues == null || vertexValues.length < vertexCount) this.meshData.vvs = vertexValues =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/vertexCount, 0);
...
this.yzPlanes[0] =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.yzCount, 0);
this.yzPlanes[1] =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.yzCount, 0);
});
...
if (this.meshDataServer == null) {
this.meshData.vcs =  Clazz.newShortArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.meshData.vc, 0);
} else {
this.meshDataServer.fillMeshData(this.meshData, 1, null);
...
if (this.haveSurfaceAtoms && this.meshData.vertexSource == null) this.meshData.vertexSource =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.meshData.vc, 0);
...
var colors = this.jvxlData.contourColixes =  Clazz.newShortArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
var values = this.jvxlData.contourValues;
if (values == null) values = this.jvxlData.contourValuesUsed;
if (this.jvxlData.contourValuesUsed == null) this.jvxlData.contourValuesUsed = (values == null ?  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0) : values);
