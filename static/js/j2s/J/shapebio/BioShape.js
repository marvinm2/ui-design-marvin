...
this.colixes =  Clazz.newShortArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.monomerCount, 0);
this.paletteIDs =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.monomerCount, 0);
this.mads =  Clazz.newShortArray (/*org.eclipse.jdt.core.dom.InfixExpression*/this.monomerCount + 1, 0);
...
if (this.colixesBack == null) this.colixesBack =  Clazz.newShortArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.colixes.length, 0);
