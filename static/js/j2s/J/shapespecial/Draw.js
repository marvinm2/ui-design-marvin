...
ms.vs = m.vs;
ms.vvs =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/m.vc, 0);
ms.vc = m.vc;
ms.pis = m.pis;
ms.pc = m.pc;
ms.dataOnly = true;
...
this.thisMesh.drawVertexCounts =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/modelCount, 0);
this.thisMesh.vc = 0;
...
this.thisMesh.pis[iModel] =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0);
}}
...
if (this.nPoints > 0) {
var p = this.thisMesh.pis[modelIndex] =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/nVertices, 0);
var pt = null;
...
this.thisMesh.pis[nPoly] =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/npoints, 0);
