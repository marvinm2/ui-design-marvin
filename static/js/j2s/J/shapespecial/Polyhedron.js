...
if (isSV) {
var lst2 = (o).getList();
var a = ai[i] =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/lst2.size(), 0);
...
var indices =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.nVertices, 0);
for (var i = this.nVertices; --i >= 0; ) {
...
if (isFaceCalc) {
var faceTypes =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.faces.length, 0);
var faceAreas =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.faces.length, 0);
...
function(forInfo){
if (forInfo) {
var a =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.nVertices, 0);
for (var i = 0; i < this.nVertices; i++) {
var pt = this.vertices[i];
a[i] = (Clazz.instanceOf(pt,"JM.Atom") ? (pt).getElementNumber() : Clazz.instanceOf(pt,"JU.Point3fi") ? (pt).sD : -2);
}
return a;
}if (this.elemNos == null) this.elemNos =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.nVertices, 0);
for (var i = 0; i < this.nVertices; i++) {
var pt = this.vertices[i];
...
this.normixes =  Clazz.newShortArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.normals.length, 0);
