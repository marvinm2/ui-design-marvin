...
case 3:
if (!this.okMF) return  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, /*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0);
search.getMaps = true;
...
var ret =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/smilesSet.length, 0);
if ((flags & 1) != 1) {
flags = flags | 2;
}this.clearExceptions();
pattern = JS.SmilesParser.cleanPattern(pattern);
...
;//5.0.1-v4 Sat Dec 21 15:36:47 CST 2024
Clazz_declarePackage("JS");
...
var eCounts = (doFinalize && setAromatic ?  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.target.ac, 0) : null);
...
}var map =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/nMatch, 0);
...
if (needRingData) {
this.ringCounts =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.ac, 0);
this.ringConnections =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.ac, 0);
...
if (atom != null) while ((atom = this.getSmilesAt(sb, atom, true, false)) != null) {
}
...
;//5.0.1-v4 Sat Dec 21 15:37:45 CST 2024
Clazz_declarePackage("JS");
...
Clazz_prepareFields (c$, function(){
this.indices =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/4, 0);
...
var vals =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/tokens.length, 0);
var i = tokens.length;
...
if (!asOneBitset) return (!firstMatchOnly ? map : map.length == 0 ?  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0) : map[0]);
var bs =  new JU.BS();
...
if (!isSmarts) return  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/bs.cardinality(), 0);
var iarray =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/bs.cardinality(), 0);
var pt = 0;
...
var angles =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/bondMap1.length, /*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
var atoms = this.e.vwr.ms.at;
JS.SmilesExt.getTorsions(atoms, bondMap2, angles, 0);
JS.SmilesExt.getTorsions(atoms, bondMap1, angles, 1);
var data =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.InfixExpression*/bondMap1.length * 6, 0);
