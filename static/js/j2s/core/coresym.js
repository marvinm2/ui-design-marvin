...
var lc = (this.latticeCells != null && this.latticeCells[0] != 0 ?  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0) : null);
...
var atomMap = (addBonds ?  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.asc.ac, 0) : null);
...
}var atomMap = (this.bondCount0 > this.asc.bondIndex0 && this.applySymmetryToBonds ?  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0) : null);
var unitCells =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/nCells, 0);
...
var f = val;
var fnew =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.InfixExpression*/f.length * nTimes, 0);
...
this.unitCellParams =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/info.length, 0);
...
var parts =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/this.asc.getAtomSetAtomCount(iset), 0);
...
function(iOp){
return this.spaceGroup.matrixOperations[iOp].subsystemCode;
}, "~N");
...
function(){
var ops = this.spaceGroup.matrixOperations;
var inv =  new JU.M4();
...
return (iop == 0 ? axes : this.spaceGroup.matrixOperations[iop].rotateAxes(axes, this.unitCell, ptTemp, mTemp));
}, "~N,~A,JU.P3,JU.M3");
/*eoif3*/})();
});
;//5.0.1-v4 Wed Dec 11 08:23:48 CST 2024
Clazz_declarePackage("JS");
Clazz_load(["J.api.SymmetryInterface"], "JS.Symmetry", ["java.util.Hashtable", "$.Stack", "JU.AU", "$.BS", "$.JSJSONParser", "$.Lst", "$.M4", "$.P3", "$.PT", "$.Rdr", "$.SB", "J.api.Interface", "J.bspt.Bspt", "JS.PointGroup", "$.SpaceGroup", "$.SymmetryInfo", "$.SymmetryOperation", "$.UnitCell", "JU.BSUtil", "$.Escape", "$.Logger", "$.SimpleUnitCell", "JV.FileManager"], function(){
var c$ = Clazz_decorateAsClass(function(){
...
function(sg0){
var sb =  new JU.SB();
var list = this.getSpaceGroupJSON(this.vwr, "ITA", "ALL", 0);
...
for (var i = 1; i < this.spaceGroup.operationCount; i++) if (doCalculate || filterSymop.contains(" " + (i + 1) + " ")) lst.addLast(this.spaceGroup.matrixOperations[i]);
...
var op = this.spaceGroup.matrixOperations[i];
...
function(pt, v0){
var ops = this.getSymmetryOperations();
if (ops == null) return  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0);
var bs =  new JU.BS();
var p =  new JU.P3();
var p0 =  new JU.P3();
var nops = ops.length;
...
var ret =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/bs.cardinality(), 0);
...
try {
var o = this.getSpaceGroupJSON(this.vwr, "subgroups", nameFrom, itaFrom);
var ithis = 0;
while (true) {
if (o == null) break;
...
if (asSSIntArray) {
var a =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/bs.cardinality(), 0);
...
if (itno == 0) {
return JS.Symmetry.getAllITAData(vwr, specialType, true);
}var isSpecial = (specialType > 0);
var resource = JS.Symmetry.getITJSONResource(vwr, specialType, itno, data);
if (resource != null) {
...
if (map != null) {
return JS.SpaceGroup.fillMoreData(vwr, map, data, itno, its.get(0));
}}}} else if (isAFLOW && tm == null) {
if (JS.Symmetry.aflowStructures == null) JS.Symmetry.aflowStructures = JS.Symmetry.getResource(vwr, "sg/json/aflow_structures.json");
...
Clazz_prepareFields (c$, function(){
this.nAxes =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/JS.PointGroup.maxAxis, 0);
...
this.elements =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/ac, 0);
if (ac == 0) return true;
var atomIndexMax = 0;
...
this.atomMap =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.InfixExpression*/atomIndexMax + 1, 0);
this.nAtoms = 0;
...
this.eCounts =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.PrefixExpression*/++this.maxElement, 0);
...
var nType =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/4, /*org.eclipse.jdt.core.dom.NumberLiteral*/2, 0);
...
if (doOffset) {
op = this.finalOperations[0] =  new JS.SymmetryOperation(this.matrixOperations[0], 0, true);
...
if (i > 0 || op == null) {
op = this.finalOperations[i] =  new JS.SymmetryOperation(this.matrixOperations[i], 0, doNormalize);
...
function(i, doNormalize){
return (this.finalOperations == null ? this.matrixOperations[i].getXyz(doNormalize) : this.finalOperations[i].getXyz(doNormalize));
}, "~N,~B");
...
for (var i = 0; i < this.operationCount; i++) {
sb.append("\n").append(this.matrixOperations[i].xyz);
}
return sb.toString();
});
...
for (var i = 0; i < this.operationCount; i++) {
lst.addLast(this.matrixOperations[i].xyz);
}
...
function(){
if (this.referenceIndex == -2 || this.index >= 0 && this.index < JS.SpaceGroup.SG.length || this.modDim > 0 || this.matrixOperations == null || this.matrixOperations.length == 0 || this.matrixOperations[0].timeReversal != 0) return this;
var s = this.getCanonicalSeitzList();
...
function(){
return JS.SpaceGroup.getCanonicalSeitzForOperations(this.matrixOperations, this.operationCount);
});
...
if (this.matrixOperations == null) this.matrixOperations =  new Array(4);
if (this.operationCount == this.matrixOperations.length) this.matrixOperations = JU.AU.arrayCopyObject(this.matrixOperations, this.operationCount * 2);
this.matrixOperations[this.operationCount++] = op;
op.number = this.operationCount;
if (op.timeReversal != 0) this.matrixOperations[0].timeReversal = 1;
...
return;
}this.matrixOperations =  new Array(4);
...
if (iop >= 0) {
var symmetryOperation = this.matrixOperations[iop];
...
var op = this.matrixOperations[i];
...
function(trm){
var t =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/2, /*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
var row =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/4, 0);
for (var i = 0; i < 3; i++) {
trm.getRow(i, row);
for (var j = 0; j < 3; j++) {
var v = row[j];
...
JS.SymmetryOperation.toPoint(cent.remove(i), pc);
...
var pos =  new JU.Lst();
var t =  new JU.M4();
var v =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/16, 0);
...
nTotal *= det;
}v =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/16, 0);
t =  new JU.M4();
...
function(i){
return this.matrixOperations[i];
}, "~N");
...
;//5.0.1-v4 Wed Dec 11 08:23:48 CST 2024
Clazz_declarePackage("JS");
Clazz_load(["JU.P3"], "JS.SpaceGroupFinder", ["JU.BS", "$.Lst", "$.M4", "$.PT", "JS.SpaceGroup", "$.Symmetry", "$.SymmetryOperation", "JU.BSUtil", "JV.FileManager"], function(){
var c$ = Clazz_decorateAsClass(function(){
this.vwr = null;
this.uc = null;
this.sg = null;
...
var allSettings = this.uc.getSpaceGroupJSON(this.vwr, "ITA", itaIndex, 0);
...
for (var i = bsGroups.nextSetBit(0); i >= 0; i = bsGroups.nextSetBit(i + 1)) {
System.out.println("SpaceGroupFinder found " + JS.SpaceGroup.nameToGroup.get(JS.SpaceGroupFinder.groupNames[i]));
}
if (n != 1) {
...
c$.setSpaceGroupAndUnitCell = Clazz_defineMethod(c$, "setSpaceGroupAndUnitCell", 
function(sg, params, oabc, allowSame){
var sym =  new JS.Symmetry();
sym.setSpaceGroupTo(sg);
if (oabc == null) {
var newParams =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/6, 0);
...
if (groups.isEmpty()) {
return (isAssign ? JS.SpaceGroup.createSpaceGroupN(xyzList, true) : null);
}if (isEqual) {
...
var minF = 2147483647;
var maxF = -2147483648;
var counts =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.InfixExpression*/101, 0);
...
this.rotCode = code;
var data =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/16, 0);
var dataInv =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/16, 0);
...
var t =  Clazz_newDoubleArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
var pt = 0;
for (var i = 0; i < n; i++) {
...
var sb =  new JU.SB();
var r =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/4, 0);
for (var i = 0; i < 3; i++) {
s.getRow(i, r);
sb.append("[\t");
...
this.linearRotTrans =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
}, "~N");
...
if (v == null) v =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/16, 0);
...
var ret =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
var len = xyz.length;
for (var i = 0; i < len; i++) {
...
var a = Math.abs(x);
return (a < 0.0001 ? "" : (x < 0 ? "-" : strT.length == 0 ? "" : "+") + (a <= 1.0001 && a > 0.9999 ? "" : a < 1 && allowFractions ? JS.SymmetryOperation.twelfthsOf(a * 12) : "" + Clazz_floatToInt(a))) + sx;
}, "~S,~N,~S,~B");
...
var a =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/16, 0);
...
if (this.itaNo.indexOf(":") > 0) return this.itaNo;
...
JS.SymmetryDesc.vtrans.setT(trans);
}color = (isGlide ? "green" : isTimeReversed && !haveInversion && !isMirrorPlane && !isRotation ? "darkGray" : "gold");
...
}info = this.createInfoArray(opTemp, uc, pt, null, (id == null ? "sym" : id), scaleFactor, options, (translation != null), bsInfo, isSpaceGroup, isSpaceGroupAll, nDim);
...
var Bcart =  Clazz_newDoubleArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/6, 0);
...
JS.UnitCell.getMatrixAndUnitCell(null, sdefs[i], m4);
...
var ftrans =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
if (atrans.length == 3) {
for (var j = 0; j < 3; j++) {
var s = atrans[j];
var sfpt = s.indexOf("/");
...
function(){
if (this.f2c == null) {
this.f2c =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, /*org.eclipse.jdt.core.dom.NumberLiteral*/4, 0);
...
var s = tokens[i].trim();
if (s.length == 0 || s.startsWith("sub") || s.startsWith("super")) continue;
