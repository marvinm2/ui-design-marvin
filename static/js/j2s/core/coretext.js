...
function(){
this.boxXY =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/5, 0);
});
...
this.textWidth = 0;
this.widths =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.lines.length, 0);
...
var ret =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/2, 0);
...
if (this.mads == null) this.mads =  Clazz_newShortArray (/*org.eclipse.jdt.core.dom.SimpleName*/ac, 0);
...
var v =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.InfixExpression*/len + 1, 0);
v[0] = len;
...
var indices =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/5, 0);
...
Clazz_prepareFields (c$, function(){
this.minZ =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
this.xy =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
...
this.boxXY = (!this.isExport || this.vwr.creatingImage ? labels.getBox(i) :  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/5, 0));
if (this.boxXY == null) labels.putBox(i, this.boxXY =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/5, 0));
...
Clazz_prepareFields (c$, function(){
this.tempXY =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
});
Clazz_overrideMethod(c$, "render", 
function(){
