...
case 4:
var s = args[0].value;
if (s.equals("h") || s.equals("r") || s.indexOf(",") >= 0 && s.indexOf(":") < 0) m4 = this.vwr.getSymTemp().convertTransform(s, null);
if (m4 != null) break;
var select = null;
...
case 3:
case 4:
a =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.InfixExpression*/len * len, 0);
...
case 4:
if (args[0].tok == 7) {
a =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.ConditionalExpression*/n == 3 ? 9 : 16, 0);
...
}return (m4 == null ? mp.addXStr("") : asABC || asXYZ ? mp.addXStr(this.matToString(m4, asABC)) : mp.addXM4(m4));
}, "JS.ScriptMathProcessor,~A");
Clazz_defineMethod(c$, "matToString", 
function(m4, asABC){
return (asABC ? this.vwr.getSymStatic().staticGetTransformABC(m4, false) : this.vwr.getSymStatic().staticConvertOperation("", m4));
}, "JU.M4,~B");
...
return mp.addXObj((itaNo == -2147483648 ? this.vwr.getCurrentUnitCell() : this.vwr.getSymTemp()).getSpaceGroupJSON(this.vwr, mode.toLowerCase(), data, itaNo));
}if ("setting".equalsIgnoreCase(xyzList) || "settings".equalsIgnoreCase(xyzList)) {
var sym = this.vwr.getOperativeSymmetry();
return mp.addXObj(sym == null ? null : sym.getSpaceGroupJSON(this.vwr, xyzList.toLowerCase(), null, -2147483648));
...
ret = this.vwr.getSymTemp().getSpaceGroupJSON(this.vwr, "ITA", s, 0);
...
break;
case 6:
var params =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/6, 0);
...
var list = x1.getList();
data =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/list.size(), 0);
...
var array =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/nbins, 0);
...
if (bs2 == null) {
var data =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/bs1.cardinality(), 0);
for (var p = 0, i = bs1.nextSetBit(0); i >= 0; i = bs1.nextSetBit(i + 1), p++) data[p] = atoms[i].distance(pt2);

return mp.addXAF(data);
}var data2 =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/bs1.cardinality(), /*org.eclipse.jdt.core.dom.MethodInvocation*/bs2.cardinality(), 0);
...
var data =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.ConditionalExpression*/isAtomSet1 ? bs1.cardinality() : list1.size(), 0);
if (isAtomSet1) {
...
if (m2.length > 0) {
map =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/bs.length(), 0);
...
ret = (map.length > 0 ? this.vwr.ms.getDihedralMap(map[0]) :  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0));
...
case 28:
case 32:
return (x.tok == 12 && mp.addXStr(this.matToString(x.value, pt == 32)));
default:
...
list1 =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.Assignment*/len = sList1.length, 0);
...
list2 =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/sList2.length, 0);
...
if (isCSV) tab = "\0";
var next =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/2, 0);
...
var pt = JU.P3.new3(JU.SimpleUnitCell.parseCalc(this.vwr, null, xyz[0]), JU.SimpleUnitCell.parseCalc(this.vwr, null, xyz[1]), JU.SimpleUnitCell.parseCalc(this.vwr, null, xyz[2]));
return pt;
}, "~S");
...
var data1 = this.e.getQuaternionArray(args[0].getList(), 1073742001);
var stddev =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
...
switch (tok) {
case 1275068935:
f =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
m.getRow(n, f);
return mp.addXAF(f);
case 1275068934:
default:
...
switch (tok) {
case 1275068935:
f =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/4, 0);
m4.getRow(n, f);
return mp.addXAF(f);
case 1275068934:
default:
...
mp.addX(x);
return this.evaluateInChI(mp,  Clazz_newArray(-1, [JS.SV.newS("SMILES")]));
}}
...
var o = null;
var narg = args.length;
if (narg == 2 && args[0].tok == 4 && args[1].tok == 4 && (args[1].value).equalsIgnoreCase("matrix")) {
return this.vwr.getSymStatic().staticConvertOperation(args[0].value, null);
}if (narg == 2 && args[0].tok == 12 && args[1].tok == 4 && (args[1].value).equalsIgnoreCase("xyz")) {
return this.vwr.getSymStatic().staticConvertOperation("", args[0].value);
}var isPoint = false;
...
if (pt1 != null) {
ret = (sym == null ?  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0) : sym.getInvariantSymops(pt1, null));
...
var fdata =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/ndata, 0);
...
if (data == null) break;
var retStddev =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
...
;//5.0.1-v4 Sat Dec 21 16:14:06 CST 2024
...
}var ptsOut =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/ap31.length, 0);
