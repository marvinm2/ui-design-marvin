...
this.dataT =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/8, 0);
});
...
this.biomtChainAtomCounts =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/255, 0);
var title = "";
var chainlist = "";
var id = "";
var needLine = true;
...
nBiomt++;
var mat =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/16, 0);
for (var i = 0; i < 12; ) {
...
function(){
var data =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/8, 0);
data[6] = 1;
...
var data =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, /*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
...
var data =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/this.asc.getAtomSetAtomCount(iModel), 0);
...
this.dataT[5] = T[1][2];
this.dataT[6] = 12;
var anisou =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/8, 0);
...
Clazz_prepareFields (c$, function(){
this.atomStartEnd =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/2, 0);
...
var offsets =  Clazz_newByteArray (/*org.eclipse.jdt.core.dom.SimpleName*/interestingCount, 0);
...
this.leadAtomIndices =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.monomerCount, 0);
...
function(){
var angles =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.monomerCount, 0);
...
var vNH =  new JU.V3();
var source;
var min1 = (min == null ?  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/2, /*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0) : null);
for (var i = 1; i < this.monomerCount; ++i) {
if (min == null) {
...
var ptrs =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/8, 0);
...
if (locs == null) map.put(name, locs =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0));
var i0 = locs[0] - 1;
if (i0 < 0) {
if (i0 == -2) {
bsAtoms.clear(i);
...
modelLoader.specialAtomIndexes =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/JM.BioResolver.ATOMID_MAX, 0);
...
var nTotal =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
...
var mapOldToNew =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.ms.ac, 0);
var mapNewToOld =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.InfixExpression*/this.ms.ac - bsDeletedAtoms.cardinality(), 0);
...
var atoms = this.ms.at;
var fData = data;
var newData =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/bsAtoms.cardinality(), 0);
var lastData = 0;
...
this.ml.group3Counts[ipt + 1] =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.InfixExpression*/JM.BioResolver.group3Count + 10, 0);
if (this.ml.group3Lists[0] == null) {
this.ml.group3Lists[0] = JM.Group.standardGroupList;
this.ml.group3Counts[0] =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.InfixExpression*/JM.BioResolver.group3Count + 10, 0);
}}, "~N");
...
;//5.0.1-v4 Sat Dec 21 16:05:43 CST 2024
Clazz_declarePackage("JM");
...
this.a = a;
this.b = b;
this.ladder =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/2, /*org.eclipse.jdt.core.dom.NumberLiteral*/2, 0);
...
min[i] =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, /*org.eclipse.jdt.core.dom.NumberLiteral*/2, /*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
for (var j = 0; j < n; ++j) {
...
this.sLeft =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/16, 0);
this.sRight =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/16, 0);
...
this.colixes =  Clazz_newShortArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.monomerCount, 0);
this.paletteIDs =  Clazz_newByteArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.monomerCount, 0);
this.mads =  Clazz_newShortArray (/*org.eclipse.jdt.core.dom.InfixExpression*/this.monomerCount + 1, 0);
...
if (this.colixesBack == null) this.colixesBack =  Clazz_newShortArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.colixes.length, 0);
...
var atomMap =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
...
if (n == 0) return;
var data =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/bsAtoms.length(), 0);
var sum = 0.0;
var sumsq = 0.0;
