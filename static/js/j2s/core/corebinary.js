...
function(){
JU.BC.fracIEEE =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/270, 0);
...
Clazz_prepareFields (c$, function(){
this.t8 =  Clazz_newByteArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/8, 0);
});
Clazz_overrideMethod(c$, "close", 
function(){
...
function(n){
var b =  Clazz_newByteArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
...
function(nChar){
var temp =  Clazz_newByteArray (/*org.eclipse.jdt.core.dom.SimpleName*/nChar, 0);
...
this.readByteArray( Clazz_newByteArray (/*org.eclipse.jdt.core.dom.CastExpression*/offset, 0), 0, offset);
}this.nBytes += offset;
} catch (e) {
if (Clazz_exceptionOf(e,"java.io.IOException")){
