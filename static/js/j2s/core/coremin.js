...
this.atomMap =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.atoms.length, 0);
...
function(){
if (this.coordSaved == null) this.coordSaved =  Clazz_newDoubleArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.ac, /*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
...
;//5.0.1-v4 Sat Dec 21 15:15:51 CST 2024
Clazz_declarePackage("JM");
(function(){
var c$ = Clazz_decorateAsClass(function(){
this.data = null;
...
Clazz_prepareFields (c$, function(){
this.coord =  Clazz_newDoubleArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
this.force =  Clazz_newDoubleArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
...
this.bondedAtoms =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.nBonds, 0);
...
Clazz_defineMethod(c$, "saveCoordinates", 
function(){
if (this.coordSaved == null) this.coordSaved =  Clazz_newDoubleArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.minAtomCount, /*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
...
Clazz_prepareFields (c$, function(){
this.typeData =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/4, 0);
});
Clazz_makeConstructor(c$, 
function(m, isQuick){
...
var partialCharges =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/atoms.length, 0);
...
var types =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/atoms.length, 0);
var bsElements =  new JU.BS();
...
var bTypes =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/bondCount, 0);
...
data.put(vs[1], p);
p.dVal =  Clazz_newDoubleArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/11, 0);
p.sVal =  new Array(1);
p.sVal[0] = vs[1];
...
p.iVal =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
...
var iVal =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.InfixExpression*/others.length + 2, 0);
...
Clazz_prepareFields (c$, function(){
this.list =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/4, 0);
});
Clazz_defineMethod(c$, "setData", 
function(calc, i){
...
Clazz_prepareFields (c$, function(){
this.minList =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/4, 0);
});
Clazz_makeConstructor(c$, 
