...
this.cchToken = 0;
this.lnLength = 8;
this.lineNumbers =  Clazz_newShortArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.lnLength, 0);
this.lineIndices =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.lnLength, /*org.eclipse.jdt.core.dom.NumberLiteral*/2, 0);
...
var lnI =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.InfixExpression*/this.lnLength * 2, /*org.eclipse.jdt.core.dom.NumberLiteral*/2, 0);
...
if (sc.lineNumbers == null) System.out.println(sc);
...
var pts =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/2, 0);
var bsOrList = null;
var forVal = null;
var forVar = null;
var inTok = 0;
...
var bs =  new JU.BS();
var iArray =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/data.length, 0);
...
if (this.vwr.rotateAboutPointsInternal(this, points[0], points[1], rate, endDegrees, isSpin, bsAtoms, translation, ptsB, dihedralList, is4x4 ? m4 : null, false, null) && this.isJS && isSpin) throw  new JS.ScriptInterruption(this, "rotate", 1);
}}, "~B,~B");
...
if (this.chk) return;
var n = v.size();
var scale =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
...
if (haveNeg) {
var b = (asBS ? null :  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0));
...
return bs;
}var ia =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
...
var ac = this.vwr.ms.ac;
var fout = (minmaxtype == 256 ?  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/ac, 0) : null);
...
if (selectedFloat) {
fout =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/len, 0);
for (var i = len; --i >= 0; ) {
var v = vout.get(i);
switch (mode) {
case 0:
...
switch (tokenValue.tok) {
case 7:
var values =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/nValues, 0);
...
nValues = list.length;
if (!isStrProperty) {
fvalues =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/nValues, 0);
...
$function.lineNumbers =  Clazz_newShortArray (/*org.eclipse.jdt.core.dom.SimpleName*/nCommands, 0);
...
function(index, mode){
var coord =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/6, 0);
var code555 =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/6, 0);
...
if (fparams == null) {
fparams =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
...
function(i){
var colors =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
var n = 0;
var hex = "";
this.getToken(i);
var pt = null;
