...
this.aTemp =  Clazz_newByteArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/16, 0);
});
...
case 85:
i = this.binaryDoc.readByte() & 0xff;
a =  Clazz_newByteArray (/*org.eclipse.jdt.core.dom.SimpleName*/i, 0);
...
if (va != null) {
varray =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/60, 0);
...
if (va != null) {
varray =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/10, 0);
for (var i = 0; i < va.length; ) varray[va[i++]] = va[i++];
...
var c =  Clazz_newShortArray (/*org.eclipse.jdt.core.dom.InfixExpression*/colixes.length + atomOffset, 0);
...
var pymolView =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/21, 0);
...
if (labelPos == null) labelPos =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/7, 0);
labelPos[0] = 1;
if (isPlacement) {
labelPos[4] = offset.x;
labelPos[5] = offset.y;
...
offset = (J.adapter.readers.pymol.PyMOLReader.floatsAt(J.adapter.readers.pymol.PyMOLReader.listAt(offsets, index), 0,  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/7, 0), 7));
if (offset == null) offset = this.setLabelPosition(this.labelPosition,  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/7, 0), false);
...
var text = this.newTextLabel(strFormat, offset, clabel, Clazz_floatToInt(this.floatSetting(328)), fontSize);
...
var colixes = (setColor == 0 ? null :  Clazz_newShortArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0));
var atrans = (setTrans == 0 ? null :  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0));
var sizes =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
...
var bytes =  Clazz_newByteArray (/*org.eclipse.jdt.core.dom.InfixExpression*/bytes0.length - nExcluded, 0);
...
this.jmolToUniqueID =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/nAtomsJmol, 0);
for (var j = 0; j < this.stateCount; j++) {
...
this.frames =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/list.size(), 0);
...
idxArray =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/nAtoms, 0);
coordsArray =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.InfixExpression*/nAtoms * 3, 0);
this.fillFloatArrayFromBytes(state.get(2), coordsArray);
this.fillIntArrayFromBytes(state.get(3), idxArray);
var b = state.get(8);
if (b != null) {
labelArray =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.InfixExpression*/nAtoms * 7, 0);
...
this.atomMap =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/nAtoms, 0);
...
var index =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
var imax = 0;
for (var i = 0; i < n; i++) {
pt += 4;
...
anisou =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/8, 0);
...
if (a.size() > 46) anisou = J.adapter.readers.pymol.PyMOLReader.floatsAt(a, 41,  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/8, 0), 6);
}if (uniqueID == 0) {
uniqueID = -1;
if (uniqueIds != null) {
...
var labelPos =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/7, 0);
if (labelArray != null) {
...
Clazz_defineMethod(c$, "checkStickBall", 
function(iatom){
...
function(){
var cartoonTypes =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.$ac, 0);
var uniqueIDs =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.$ac, 0);
var sequenceNumbers =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.$ac, 0);
var newChain =  Clazz_newBooleanArray(this.$ac, false);
var radii =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.$ac, 0);
