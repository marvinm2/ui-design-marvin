...
if (this.tokAt(i) == 4) {
fparams =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/6, 0);
...
var retStddev =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/2, 0);
...
if (this.vwr.rotateAboutPointsInternal(eval, center, pt1, endDegrees / nSeconds, endDegrees, doAnimate, bsFrom, translation, ptsB, null, null, false, centerAndPoints) && doAnimate && eval.isJS) throw  new JS.ScriptInterruption(eval, "compare", 1);
}
});
...
var atomIndex = -1;
var ptFloat = -1;
var countPlusIndexes =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/5, 0);
...
function(index){
var eval = this.e;
var distances =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/2, 0);
...
var eArray =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.InfixExpression*/n + 1, 0);
...
atomMap =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.InfixExpression*/ac + 2, 0);
...
var dataOut =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.ConditionalExpression*/isProperty ? this.vwr.ms.ac : data3.length, 0);
bsOut =  new JU.BS();
...
var n = 0;
var targetValue = 0;
var aList =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/5, 0);
...
var propToks =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
...
if (colorpt == 0) colors =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/2, 0);
...
JU.PT.parseFloatArrayData(tokens, data[iLine] =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/tokens.length, 0));
}
return data;
}var tokens = JU.PT.getTokens(str.substring(0, lines[0]));
if (tokens.length != 3) return  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, /*org.eclipse.jdt.core.dom.NumberLiteral*/0, /*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0);
var nX = JU.PT.parseInt(tokens[0]);
var nY = JU.PT.parseInt(tokens[1]);
var nZ = JU.PT.parseInt(tokens[2]);
if (nX < 1 || nY < 1 || nZ < 1) return  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, /*org.eclipse.jdt.core.dom.NumberLiteral*/1, /*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
...
JU.PT.parseFloatArrayData(tokens, data[iX][iY] =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/tokens.length, 0));
if (++iY == nY) {
iX++;
iY = 0;
}}
...
return  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, /*org.eclipse.jdt.core.dom.NumberLiteral*/1, /*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
}return data;
}, "~S,~B");
...
if (odata == null || !JU.AU.isAF(odata)) return (bs == null ? null :  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/bs.cardinality(), 0));
var data = odata;
...
;//5.0.1-v4 Sat Dec 21 16:49:36 CST 2024
})(Clazz
,Clazz.getClassName
,Clazz.newLongArray
,Clazz.doubleToByte
