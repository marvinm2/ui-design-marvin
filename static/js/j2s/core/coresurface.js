...
faces[vi] =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/face.size(), 0);
...
return;
case 4106:
connections =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/4, 0);
iConnect = 4;
...
opList =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/params.length, 0);
...
this.e.iToken++;
return  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0);
}, "JU.Lst");
...
lc =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
...
data =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.vwr.ms.ac, 0);
...
data =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/ac, 0);
if (isVariable) {
...
if (linearCombination == null) linearCombination =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0);
...
}var nlmZprs =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/7, 0);
...
var factors =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
sbCommand.append("[");
try {
...
if (this.isFloatParameter(i + 1)) {
if (params == null) params =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
...
params = (params == null ?  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/2, 0) : JU.AU.ensureLengthA(params, 2));
...
var potentials =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.vwr.ms.ac, 0);
...
case 268437504:
i++;
var f =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/nY, 0);
fparams[n++] = f;
for (var j = 0; j < nY; j++) {
...
var t1 =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/4, 0);
...
var insideMask = 0;
var values =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/8, 0);
for (var i = 0; i < 8; i++) {
...
v.addLast(pts);
var list =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/12, 0);
var ptList = 0;
for (var i = 0; i < triangles.length; i++) {
var pt = triangles[i];
if (bsPoints.get(pt)) {
...
;//5.0.1-v4 Sat Dec 21 16:40:00 CST 2024
...
atomMap =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/bs.length(), 0);
...
this.sg.params.probeValues =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.sg.params.probes.length, 0);
}return;
...
this.setProperty("property",  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.ms.ac, 0), null);
if (colix != 0) {
...
return;
case 2:
if (mesh.vcs == null || mesh.vc > mesh.vcs.length) mesh.vcs =  Clazz_newShortArray (/*org.eclipse.jdt.core.dom.QualifiedName*/mesh.vc, 0);
...
;//5.0.1-v4 Sat Dec 21 16:40:35 CST 2024
...
var vertexIdNew =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/meshData.vc, 0);
...
removeSlabbed = false;
vertexIdOld =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/vertexCount, 0);
...
var ptr = 0;
var isset = false;
var next =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
...
this.origin =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
this.volumetricVectors =  new Array(3);
this.voxelCounts =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
this.volumetricVectorLengths =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
...
this.voxelData =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/nx, /*org.eclipse.jdt.core.dom.SimpleName*/ny, /*org.eclipse.jdt.core.dom.SimpleName*/nz, 0);
...
return;
}this.vertexSets =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.vc, 0);
...
var v =  Clazz_newDoubleArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
var vAB =  new JU.V3();
var vAC =  new JU.V3();
var vTemp =  new JU.V3();
for (var i = m.pc; --i >= 0; ) {
...
var v1 =  Clazz_newDoubleArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/thisSet.cardinality(), 0);
...
function(data, what){
var nexta =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
...
this.params.contoursDiscrete =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
var p = from;
...
var counts =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
var nearest =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
...
var data2 =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/nx, /*org.eclipse.jdt.core.dom.SimpleName*/ny, 0);
var d;
...
;//5.0.1-v4 Sat Dec 21 16:34:31 CST 2024
Clazz_declarePackage("J.jvxl.readers");
...
Clazz_prepareFields (c$, function(){
this.anisotropy =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
});
...
function(){
this.volumeData.setVoxelDataAsArray(this.voxelData =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.nPointsX, /*org.eclipse.jdt.core.dom.SimpleName*/this.nPointsY, /*org.eclipse.jdt.core.dom.SimpleName*/this.nPointsZ, 0));
});
...
if (colixes == null || colixes.length < vertexCount) this.meshData.vcs = colixes =  Clazz_newShortArray (/*org.eclipse.jdt.core.dom.SimpleName*/vertexCount, 0);
if (vertexValues == null || vertexValues.length < vertexCount) this.meshData.vvs = vertexValues =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/vertexCount, 0);
...
this.yzPlanes[0] =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.yzCount, 0);
this.yzPlanes[1] =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.yzCount, 0);
});
Clazz_overrideMethod(c$, "getValue", 
function(x, y, z, ptyz){
...
if (this.meshDataServer == null) {
this.meshData.vcs =  Clazz_newShortArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.meshData.vc, 0);
} else {
this.meshDataServer.fillMeshData(this.meshData, 1, null);
...
if (this.haveSurfaceAtoms && this.meshData.vertexSource == null) this.meshData.vertexSource =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.meshData.vc, 0);
...
var colors = this.jvxlData.contourColixes =  Clazz_newShortArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
var values = this.jvxlData.contourValues;
if (values == null) values = this.jvxlData.contourValuesUsed;
if (this.jvxlData.contourValuesUsed == null) this.jvxlData.contourValuesUsed = (values == null ?  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0) : values);
...
this.vertexValues =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/8, 0);
this.voxelVertexVectors =  new Array(8);
this.edgeVectors =  new Array(12);
{
for (var i = 12; --i >= 0; ) this.edgeVectors[i] =  new JU.V3();

}this.edgePointIndexes =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/12, 0);
this.bsValues =  new JU.BS();
this.pt0 =  new JU.P3();
this.pointA =  new JU.P3();
this.fReturn =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
this.linearOffsets =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/8, 0);
});
Clazz_makeConstructor(c$, 
function(){
...
this.isoPointIndexPlanes =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/2, /*org.eclipse.jdt.core.dom.SimpleName*/this.yzCount, /*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
this.yzPlanes = (this.mode == 3 ?  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/2, /*org.eclipse.jdt.core.dom.SimpleName*/this.yzCount, 0) : null);
...
var diff = max - min;
this.contourValuesUsed =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.nContourSegments, 0);
...
function(){
if (this.vcs == null) {
this.vcs =  Clazz_newShortArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.vc, 0);
...
}this.jvxlData.contourColixes =  Clazz_newShortArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
this.jvxlData.contourValues =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
for (var i = 0; i < n; i++) {
...
this.pcs =  Clazz_newShortArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.pc, 0);
this.colorsExplicit = false;
for (var i = 0; i < this.pc; i++) {
var p = this.pis[i];
if (p == null) continue;
...
this.jvxlData.vertexColors =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.vc, 0);
...
this.contourColixes =  Clazz_newShortArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.contourValues.length, 0);
...
if (this.pis == null) this.pis =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, /*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0);
if (m != null && m.pis == null) m.pis =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, /*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0);
...
var v =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
...
;//5.0.1-v4 Sat Dec 21 16:39:59 CST 2024
Clazz_declarePackage("J.jvxl.readers");
...
var strip = plane[y] =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.nPointsZ, 0);
...
if (getRadii) this.atomRadius =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
this.atomXyzTruncated =  new Array(n);
if (this.params.theProperty != null) this.atomProp =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
this.atomNo =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
this.atomIndex =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
this.myIndex =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.ac, 0);
for (var i = 0; i < nH; i++) {
...
this.maxRS = 0;
this.rs =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.myAtomCount, 0);
this.rs2 =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.myAtomCount, 0);
...
this.voxelSource =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.volumeData.nPoints, 0);
}return true;
}, "~B");
Clazz_overrideMethod(c$, "setup", 
function(isMapData){
...
this.atomRadius =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
this.atomXyzTruncated =  new Array(n);
...
this.params.vertexSource =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.volumeData.nPoints, 0);
...
Clazz_prepareFields (c$, function(){
this.next =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
});
Clazz_makeConstructor(c$, 
function(){
...
;//5.0.1-v4 Sat Dec 21 16:35:24 CST 2024
Clazz_declarePackage("J.jvxl.readers");
...
if (downsampling) {
this.downsampleRemainders =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
...
this.voxelData[x] = plane;
for (var y = 0; y < this.nPointsY; ++y) {
var strip =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.nPointsZ, 0);
plane[y] = strip;
for (var z = 0; z < this.nPointsZ; ++z) {
...
this.iPlaneNCI = 1;
this.qpc.setPlanes(this.yzPlanesRaw =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/4, /*org.eclipse.jdt.core.dom.SimpleName*/this.yzCount, 0));
...
this.jvxlData.vertexColors =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/vertexCount, 0);
var nextc =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
...
var vertex =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
var nextp =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
var nexte = null;
var edgeMask = 7;
var haveEdgeInfo;
...
if (haveEdgeInfo) {
nexte =  Clazz_newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
...
jvxlData.contourColixes = this.params.contourColixes =  Clazz_newShortArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
jvxlData.contourValues = this.params.contoursDiscrete =  Clazz_newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
for (var i = 0; i < n; i++) {
