...
var t =  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
var pt = 0;
for (var i = 0; i < n; i++) {
...
var sb =  new JU.SB();
var r =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/4, 0);
for (var i = 0; i < 3; i++) {
s.getRow(i, r);
sb.append("[\t");
...
this.linearRotTrans =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
}, "~N");
...
if (v == null) v =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/16, 0);
...
var ret =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
var len = xyz.length;
for (var i = 0; i < len; i++) {
...
var a = Math.abs(x);
return (a < 0.0001 ? "" : (x < 0 ? "-" : strT.length == 0 ? "" : "+") + (a <= 1.0001 && a > 0.9999 ? "" : a < 1 && allowFractions ? JS.SymmetryOperation.twelfthsOf(a * 12) : "" + Clazz.floatToInt(a))) + sx;
}, "~S,~N,~S,~B");
...
var a =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/16, 0);
