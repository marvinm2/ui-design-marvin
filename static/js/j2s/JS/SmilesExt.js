...
if (!asOneBitset) return (!firstMatchOnly ? map : map.length == 0 ?  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0) : map[0]);
var bs =  new JU.BS();
...
if (!isSmarts) return  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/bs.cardinality(), 0);
var iarray =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/bs.cardinality(), 0);
var pt = 0;
...
var angles =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/bondMap1.length, /*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
var atoms = this.e.vwr.ms.at;
JS.SmilesExt.getTorsions(atoms, bondMap2, angles, 0);
JS.SmilesExt.getTorsions(atoms, bondMap1, angles, 1);
var data =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.InfixExpression*/bondMap1.length * 6, 0);
