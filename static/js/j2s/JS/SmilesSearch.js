...
var eCounts = (doFinalize && setAromatic ?  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.target.ac, 0) : null);
...
}var map =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/nMatch, 0);
...
if (needRingData) {
this.ringCounts =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.ac, 0);
this.ringConnections =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.ac, 0);
