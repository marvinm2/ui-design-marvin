...
Clazz.load(["JU.P3"], "JS.SpaceGroupFinder", ["JU.BS", "$.Lst", "$.M4", "$.PT", "JS.SpaceGroup", "$.Symmetry", "$.SymmetryOperation", "JU.BSUtil", "JV.FileManager"], function(){
...
if (oabc == null) {
var newParams =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/6, 0);
...
var minF = 2147483647;
var maxF = -2147483648;
var counts =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.InfixExpression*/101, 0);
