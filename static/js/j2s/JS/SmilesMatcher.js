...
case 3:
if (!this.okMF) return  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, /*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0);
search.getMaps = true;
...
var ret =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/smilesSet.length, 0);
if ((flags & 1) != 1) {
flags = flags | 2;
}this.clearExceptions();
pattern = JS.SmilesParser.cleanPattern(pattern);
