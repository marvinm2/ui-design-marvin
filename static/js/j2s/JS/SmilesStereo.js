...
map = this.getMappedTopoAtoms(sAtom0, a2, cAtoms, chiralOrder == 0 ?  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/cAtoms.length, 0) : null);
}var pt;
switch (chClass) {
case 1:
sAtom0.set(0, 0, 0.2);
...
if (map == null) map =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.ConditionalExpression*/cAtoms[4] == null ? 4 : cAtoms[5] == null ? 5 : 6, 0);
...
}var temp =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/this.details.length, 0);
...
break;
}var a = po[atomPt] =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
for (; --n >= 0; ) a[n] = temp[n];
