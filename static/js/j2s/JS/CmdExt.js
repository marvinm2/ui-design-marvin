...
if (this.tokAt(i) == 4) {
fparams =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/6, 0);
...
var retStddev =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/2, 0);
...
var atomIndex = -1;
var ptFloat = -1;
var countPlusIndexes =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/5, 0);
...
function(index){
var eval = this.e;
var distances =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/2, 0);
...
var eArray =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.InfixExpression*/n + 1, 0);
...
atomMap =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.InfixExpression*/ac + 2, 0);
...
var dataOut =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.ConditionalExpression*/isProperty ? this.vwr.ms.ac : data3.length, 0);
bsOut =  new JU.BS();
...
var n = 0;
var targetValue = 0;
var aList =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/5, 0);
...
var propToks =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
...
if (colorpt == 0) colors =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/2, 0);
...
JU.PT.parseFloatArrayData(tokens, data[iLine] =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/tokens.length, 0));
}
return data;
}var tokens = JU.PT.getTokens(str.substring(0, lines[0]));
if (tokens.length != 3) return  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, /*org.eclipse.jdt.core.dom.NumberLiteral*/0, /*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0);
var nX = JU.PT.parseInt(tokens[0]);
var nY = JU.PT.parseInt(tokens[1]);
var nZ = JU.PT.parseInt(tokens[2]);
if (nX < 1 || nY < 1 || nZ < 1) return  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, /*org.eclipse.jdt.core.dom.NumberLiteral*/1, /*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
...
JU.PT.parseFloatArrayData(tokens, data[iX][iY] =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/tokens.length, 0));
if (++iY == nY) {
iX++;
iY = 0;
}}
...
return  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, /*org.eclipse.jdt.core.dom.NumberLiteral*/1, /*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
}return data;
}, "~S,~B");
...
if (odata == null || !JU.AU.isAF(odata)) return (bs == null ? null :  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/bs.cardinality(), 0));
var data = odata;
