...
var Bcart =  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/6, 0);
...
var ftrans =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
if (atrans.length == 3) {
for (var j = 0; j < 3; j++) {
var s = atrans[j];
var sfpt = s.indexOf("/");
...
function(){
if (this.f2c == null) {
this.f2c =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, /*org.eclipse.jdt.core.dom.NumberLiteral*/4, 0);
