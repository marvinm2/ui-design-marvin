...
function(trm){
var t =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/2, /*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
var row =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/4, 0);
for (var i = 0; i < 3; i++) {
trm.getRow(i, row);
for (var j = 0; j < 3; j++) {
var v = row[j];
...
var pos =  new JU.Lst();
var t =  new JU.M4();
var v =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/16, 0);
...
nTotal *= det;
}v =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/16, 0);
t =  new JU.M4();
