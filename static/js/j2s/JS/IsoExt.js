...
return;
case 4106:
connections =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/4, 0);
iConnect = 4;
...
opList =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/params.length, 0);
...
this.e.iToken++;
return  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0);
}, "JU.Lst");
...
lc =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
...
data =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.vwr.ms.ac, 0);
...
data =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/ac, 0);
if (isVariable) {
...
if (linearCombination == null) linearCombination =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0);
...
}var nlmZprs =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/7, 0);
...
var factors =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/n, 0);
sbCommand.append("[");
try {
...
if (this.isFloatParameter(i + 1)) {
if (params == null) params =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
...
params = (params == null ?  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/2, 0) : JU.AU.ensureLengthA(params, 2));
...
var potentials =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.vwr.ms.ac, 0);
...
case 268437504:
i++;
var f =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/nY, 0);
fparams[n++] = f;
for (var j = 0; j < nY; j++) {
