...
case 3:
case 4:
a =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.InfixExpression*/len * len, 0);
...
case 4:
if (args[0].tok == 7) {
a =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.ConditionalExpression*/n == 3 ? 9 : 16, 0);
...
break;
case 6:
var params =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/6, 0);
...
var list = x1.getList();
data =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/list.size(), 0);
...
var array =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/nbins, 0);
...
if (bs2 == null) {
var data =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/bs1.cardinality(), 0);
for (var p = 0, i = bs1.nextSetBit(0); i >= 0; i = bs1.nextSetBit(i + 1), p++) data[p] = atoms[i].distance(pt2);

return mp.addXAF(data);
}var data2 =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/bs1.cardinality(), /*org.eclipse.jdt.core.dom.MethodInvocation*/bs2.cardinality(), 0);
...
var data =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.ConditionalExpression*/isAtomSet1 ? bs1.cardinality() : list1.size(), 0);
if (isAtomSet1) {
...
if (m2.length > 0) {
map =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/bs.length(), 0);
...
ret = (map.length > 0 ? this.vwr.ms.getDihedralMap(map[0]) :  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0));
...
var ret =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/bs.cardinality(), 0);
...
list1 =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.Assignment*/len = sList1.length, 0);
...
list2 =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/sList2.length, 0);
...
if (isCSV) tab = "\0";
var next =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/2, 0);
...
var data1 = this.e.getQuaternionArray(args[0].getList(), 1073742001);
var stddev =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
...
switch (tok) {
case 1275068935:
f =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
m.getRow(n, f);
return mp.addXAF(f);
case 1275068934:
default:
...
switch (tok) {
case 1275068935:
f =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/4, 0);
m4.getRow(n, f);
return mp.addXAF(f);
case 1275068934:
default:
...
mp.addX(x);
return this.evaluateInChI(mp,  Clazz.newArray(-1, [JS.SV.newS("SMILES")]));
}}
...
if (pt1 != null) {
ret = (sym == null ?  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/0, 0) : sym.getInvariantSymops(pt1, null));
...
var fdata =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/ndata, 0);
...
if (data == null) break;
var retStddev =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0);
