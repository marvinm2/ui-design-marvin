...
var ac = this.vwr.ms.ac;
var fout = (minmaxtype == 256 ?  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/ac, 0) : null);
...
if (selectedFloat) {
fout =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/len, 0);
for (var i = len; --i >= 0; ) {
var v = vout.get(i);
switch (mode) {
case 0:
...
switch (tokenValue.tok) {
case 7:
var values =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/nValues, 0);
...
nValues = list.length;
if (!isStrProperty) {
fvalues =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/nValues, 0);
