...
var data =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/len, 0);
if (len == 3) {
...
var b =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.InfixExpression*/Math.min(i2, len) - i1, 0);
...
data =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/len, 0);
...
var vd = (strFormat.indexOf("d") >= 0 || strFormat.indexOf("i") >= 0 ?  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0) : null);
var vf = (strFormat.indexOf("f") >= 0 ?  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0) : null);
var ve = (strFormat.indexOf("e") >= 0 ?  Clazz.newDoubleArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/1, 0) : null);
...
function(format){
return (format.indexOf(";") >= 0 ? -1 : ";json;base64;bytearray;array;xyz;abc;".indexOf(";" + format.toLowerCase() + ";"));
}, "~S");
...
return l1;
}bytes =  Clazz.newByteArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/l.size(), 0);
...
var sv = (x).getList();
var list;
list =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/Math.max(nMin, sv.size()), 0);
if (nMin == 0) nMin = list.length;
...
o2 =  new JU.Lst();
for (var i = 0; i < dim; i++) {
var a =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/dim, 0);
