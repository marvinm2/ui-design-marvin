...
if (asMinArray) {
this.minArray =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/(this.points.get(0)).cardinality(), 0);
...
var modelIndex = -1;
var pts =  new Array(4);
var indices =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/5, 0);
