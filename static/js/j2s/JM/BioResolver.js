...
modelLoader.specialAtomIndexes =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/JM.BioResolver.ATOMID_MAX, 0);
...
var mapOldToNew =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.ms.ac, 0);
var mapNewToOld =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.InfixExpression*/this.ms.ac - bsDeletedAtoms.cardinality(), 0);
...
var atoms = this.ms.at;
var fData = data;
var newData =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.MethodInvocation*/bsAtoms.cardinality(), 0);
var lastData = 0;
...
this.ml.group3Counts[ipt + 1] =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.InfixExpression*/JM.BioResolver.group3Count + 10, 0);
if (this.ml.group3Lists[0] == null) {
this.ml.group3Lists[0] = JM.Group.standardGroupList;
this.ml.group3Counts[0] =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.InfixExpression*/JM.BioResolver.group3Count + 10, 0);
}}, "~N");
