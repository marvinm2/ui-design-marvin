...
function(){
var charges =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.ac, 0);
...
this.surfaceDistance100s =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.ac, 0);
...
if (this.atomSerials == null) this.atomSerials =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.at.length, 0);
...
if (this.atomResnos == null) this.atomResnos =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.at.length, 0);
...
if (this.atomSeqIDs == null) this.atomSeqIDs =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.at.length, 0);
...
this.occupancies =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.at.length, 0);
...
this.partialCharges =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.at.length, 0);
...
this.bondingRadii =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.at.length, 0);
...
if (bfactor == 0) return;
this.bfactor100s =  Clazz.newShortArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.at.length, 0);
...
this.hydrophobicities =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.QualifiedName*/this.at.length, 0);
...
return;
case 18:
fData =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.ac, 0);
...
atomData.ac = this.ac;
atomData.atomicNumber =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.ac, 0);
var includeRadii = ((mode & 2) != 0);
if (includeRadii) atomData.atomRadius =  Clazz.newFloatArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.ac, 0);
...
if (this.aaRet == null) this.aaRet =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/5, 0);
...
var ntypes =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, 0);
var typePtrs =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/3, /*org.eclipse.jdt.core.dom.SimpleName*/nAngles, 0);
var n = 0;
var _90 = 0;
var _120 = 1;
var _180 = 2;
...
return bs;
case 1612709912:
var hs =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.NumberLiteral*/2, 0);
var a;
for (var i = this.ac; --i >= 0; ) {
if (JM.AtomCollection.isDeleted(this.at[i])) continue;
...
function(bs){
var n = 0;
var indices =  Clazz.newIntArray (/*org.eclipse.jdt.core.dom.SimpleName*/this.ac, 0);
